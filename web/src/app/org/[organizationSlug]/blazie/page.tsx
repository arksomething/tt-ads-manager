...
import { UgcStatusClient } from "../ugc-status/ugc-status-client";

export const dynamic = "force-dynamic";

type BlaziePageProps = {
  params: Promise<{
...
export default async function BlaziePage({
  params,
  searchParams,
}: BlaziePageProps) {
  ...
  const initialData = await getUgcStatusData({
    endDate,
    organizationSlug,
